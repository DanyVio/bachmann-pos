...
describe('Content page', function () {
  ...
  it('components home page', function () {
    ...
    cy.get('.flex > img')
      .should('be.visible')
      .click();
    cy.get(':nth-child(4) > .widget > .home-category-promotion-container > .home-category-promotion-wrapper > :nth-child(1) > a > img')
      .should('be.visible')
      .click();
    cy.get('.flex > img')
      .should('be.visible')
    ...
    //   .click();
    cy.scrollTo('bottom')
    cy.get(':nth-child(1) > .product-item-info > .product-image > .product-item-photo > .product-image-container > .product-image-wrapper > .product-image-photo')
      .should('be.visible')
      .click();
    cy.get('.flex > img')
      .should('be.visible')
